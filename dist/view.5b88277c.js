...
function () {
  ...
  MediaPlayer.prototype.isPlaying = function () {
    var isPlaying = this.media.currentTime > 0 && !this.media.paused && !this.media.ended && this.media.readyState > 2;
    return isPlaying;
  };
...
var play = document.getElementById("play_pause");
var mute = document.getElementById("mute");
var player = new MediaPlayer_1.default({
  el: videoEl,
  plugins: [new AutoPause_1.default(), new AutoPlay_1.default()]
});
...
//   }
// }
},{"../plugins/AutoPlay":"plugins/AutoPlay.ts","./MediaPlayer":"src/MediaPlayer.ts","../plugins/AutoPause":"plugins/AutoPause.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/view.ts"], null)
//# sourceMappingURL=/view.5b88277c.js.map